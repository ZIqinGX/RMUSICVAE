...
class MeasureVAE(nn.Module):
    def __init__(self, dataset,
        ...
        self.model_dir ="MeasureVAE/models"
        os.makedirs(self.model_dir, exist_ok=True)

        self.filepath = os.path.join(self.model_dir, "MeasureVAE.pt")
        # define constants
    ...
    def save(self):
        ...
        """
        os.makedirs(self.model_dir, exist_ok=True)
        safe_filename = f"MeasureVAE_{str(self.dataset)}_Encoder_{self.encoder_hidden_size}_Decoder_{self.decoder_hidden_size}.pt"
        self.filepath = os.path.join(self.model_dir, safe_filename)

        print(f"✅ 正在保存模型到: {self.filepath}")
